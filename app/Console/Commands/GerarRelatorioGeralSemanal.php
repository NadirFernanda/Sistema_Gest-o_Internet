...
class GerarRelatorioGeralSemanal extends Command
{
    protected $signature = 'relatorio:geral-semanal {--field=data_vencimento : Campo de data para filtrar (data_vencimento|data_pagamento)}';
    protected $description = 'Gera e envia o relatório geral semanal (multi-aba) do sistema';
    ...
    public function handle()
    {
        ...
        try {
            ...
            \Log::error('Falha ao gerar/enviar relatório geral semanal: ' . $e->getMessage(), ['exception' => $e]);
            $this->error('Erro ao gerar relatório geral semanal: ' . $e->getMessage());
            return 1;
        }
        return 0;
    }
