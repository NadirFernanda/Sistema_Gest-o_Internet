...
<div class="container">
    ...
    .input:focus, .select:focus { outline:none; border-color:#f1b400; box-shadow:0 6px 24px rgba(240,180,0,0.12); }
    ...
    .btn-cta { background:#ffb800; color:#fff; border:none; padding:12px 22px; border-radius:10px; font-weight:700; display:inline-flex; align-items:center; box-shadow:0 6px 18px rgba(240,180,0,0.18); cursor:pointer; }
    .btn-cta:hover { background:#e09b00; }
