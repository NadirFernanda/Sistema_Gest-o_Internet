                ...
                <div style="display:flex;gap:8px;align-items:center;">
                    ...
                    @can('clientes.devolucao')
                        <form action="{{ route('cliente.solicitar_devolucao', $cliente->id) }}" method="POST" style="display:inline-block;margin:0;">
                            ...
                            <button type="submit" class="btn btn-secondary" onclick="return confirm('Confirmar solicitação de devolução para todos os equipamentos emprestados deste cliente?')">Solicitar Devolução</button>
                        </form>
                    @endcan
                </div>
                @php
