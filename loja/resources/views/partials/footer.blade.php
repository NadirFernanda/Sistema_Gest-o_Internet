<footer class="site-footer" role="contentinfo" aria-label="Rodapé da loja">
  ...
  <div class="footer-inner">
    ...
    <div class="footer-col footer-brand-col">
      <a href="/" class="footer-brand-link" aria-label="Voltar à página inicial">
        <img src="{{ asset('img/logo2.jpeg') }}" alt="AngolaWiFi" class="footer-logo" width="48" height="48">
        <span class="footer-brand-name">AngolaWiFi</span>
      </a>
      <p class="footer-tagline">Conectando vidas, lares e negócios em Angola.</p>
      <div class="footer-social" aria-label="Redes sociais">
        <a href="https://wa.me/244949364505" target="_blank" rel="noopener" aria-label="WhatsApp" class="social-link social-link--wa">
    ...
    <div class="footer-col footer-contact-col">
      ...
      <ul class="footer-contact-list">
        <li>
          ...
          <a href="tel:+244949364505">+244 949 364 505</a>
        </li>
        <li>
          <span class="footer-contact-icon">
            <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
          </span>
          <a href="mailto:suporte@angolawifi.ao">suporte@angolawifi.ao</a>
        </li>
        <li>
          <span class="footer-contact-icon">
  ...
  <div class="footer-legal">
    <div class="footer-legal-inner">
      <small>&copy; {{ date('Y') }} AngolaWiFi. Todos os direitos reservados.</small>
      <span class="footer-legal-sep" aria-hidden="true"></span>
      <small class="dev-credit">Desenvolvido por Fernanda Gonçalves</small>
      <span class="footer-legal-sep" aria-hidden="true"></span>
